...
class ControllerProductCompare extends Controller {
	public function index() {
        ...
        if ($hd_imgs) {
          $image2x = $this->model_tool_image->resize($product_info['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_width')*2, $this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_height')*2);
          $image3x = $this->model_tool_image->resize($product_info['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_width')*3, $this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_height')*3);
          $image4x = $this->model_tool_image->resize($product_info['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_width')*4, $this->config->get('theme_' . $this->config->get('config_theme') . '_image_compare_height')*4);
        }
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['total'] = sprintf($this->language->get('text_compare'), (isset($this->session->data['compare']) ? count($this->session->data['compare']) : 0));
				...
				$json['total'] = sprintf($this->language->get('g_text_compare'), (isset($this->session->data['compare']) ? count($this->session->data['compare']) : 0));
